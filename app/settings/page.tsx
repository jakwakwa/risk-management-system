					...
					<form action={updateSystemConfig} className="space-y-6">
						...
						<div className="space-y-2">
							...
							<Select name="phoneticAlgorithm" defaultValue={config.phoneticAlgorithm}>
								...
								<SelectContent>
									<SelectItem value="BMPM">
										{form.phoneticAlgorithm.options.bmpm}
									</SelectItem>
									<SelectItem value="DoubleMetaphone">
										{form.phoneticAlgorithm.options.doubleMetaphone}
									</SelectItem>
									<SelectItem value="Soundex">
										{form.phoneticAlgorithm.options.soundex}
									</SelectItem>
								</SelectContent>
							</Select>
							<p className="text-xs text-muted-foreground">
