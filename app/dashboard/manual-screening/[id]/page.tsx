		...
		<div className="flex flex-col gap-6 p-6 max-w-4xl mx-auto print:p-0 print:max-w-none">
			...
			<div className="space-y-3">
				<Card className="print:border-0 print:shadow-none">
					...
					<CardContent className="pt-0 mt-0 space-y-12">
						{/* Client Info Grid */}
						<div className="bg-chart-5 grid grid-cols-2 gap-8 p-4 rounded-lg print:bg-transparent print:p-0">
							<div>
						...
						<div>
							...
							<div className="prose max-w-none text-muted-foreground dark:text-gray-300 whitespace-pre-wrap">
								{report.findings}
							</div>
						</div>
					</CardContent>
				...
				<div className="hidden print:block text-center text-xs text-muted-foreground mt-10 pt-10 border-t">
					Confidential Risk Management Report &bull; Generated on{" "}
